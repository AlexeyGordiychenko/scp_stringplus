...
START_TEST(sscanf_spec_c_2) {
  ...
  int16_t res1 = scp_sscanf(str, format, &c1);
...
START_TEST(sscanf_spec_c_5) {
  ...
  int16_t res1 = scp_sscanf(str, format, &c11, &c12, &c13);
...
START_TEST(sscanf_spec_c_8) {
  ...
  int16_t res1 = scp_sscanf(str, format, &c11, &c12);
...
START_TEST(sscanf_spec_c_10) {
  ...
  int16_t res1 = scp_sscanf(str, format, &c11, &c12, c13, &c14);
...
START_TEST(sscanf_spec_wc_2) {
  ...
  int res1 = scp_sscanf(str1, format1, &c1);
...
START_TEST(sscanf_spec_wc_3) {
  ...
  int res1 = scp_sscanf(str1, format1, c11, &c12, &c13);
...
START_TEST(sscanf_spec_wc_8) {
  ...
  int res1 = scp_sscanf(str1, format1, &c11, &c12);
...
Suite *test_sscanf_c(void) {
  Suite *s = suite_create("\033[33m-=scp_sscanf_c=-\033[0m");
