...
START_TEST(sprintf_16_s) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val, val2, val4, val3),
                   scp_sprintf(str2, str3, val, val2, val4, val3));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_17_s) {
  ...
  char *val = NULL;
  ck_assert_int_eq(scp_sprintf(str2, str3, val, val, val, val, val, val, val,
                               val, val, val, val, val),
...
START_TEST(sprintf_18_s) {
  ...
  int len21 = scp_sprintf(str2, str3, val, val1, val2, val3);
...
START_TEST(sprintf_20_s) {
  ...
  int len21 = scp_sprintf(str2, str3, val, val4, val1, val2, val4, val4, val3);
  int len =
...
START_TEST(sprintf_21_s) {
  ...
  char *str3 = "%ls";
  char *val = NULL;
  ck_assert_int_eq(scp_sprintf(str2, str3, val), sprintf(str1, str3, val));
  ck_assert_str_eq(str1, str2);
}
END_TEST

Suite *test_sprintf_s(void) {
  Suite *s = suite_create("\033[33m-=scp_sprintf_s=-\033[0m");
