...
START_TEST(sscanf_spec_n_1) {
  ...
  int16_t res1 = scp_sscanf(str, format, &n1);
...
START_TEST(sscanf_spec_n_2) {
  ...
  int16_t res1 = scp_sscanf(str, format, &d1, &n1);
...
START_TEST(sscanf_spec_n_3) {
  ...
  int16_t res1 = scp_sscanf(str, format, &d1, &dd1, &n1, &f1, &ff1, &k1);
...
START_TEST(sscanf_spec_n_5) {
  ...
  int16_t res1 =
      scp_sscanf(str, format, &d1, &hn1, &dd1, &hhn1, &f1, &ff1, &n1, &k1);
  int16_t res2 =
...
START_TEST(sscanf_spec_n_8) {
  ...
  int16_t res1 =
      scp_sscanf(str, format, &s1, &hn1, &s3, &hhn1, &s5, &s7, &s9, &n1);
  int16_t res2 =
...
START_TEST(sscanf_spec_n_9) {
  ...
  int16_t res1 = scp_sscanf(str, format, &d1, &dd1, &f1, &ff1, &n1, &k1);
...
START_TEST(sscanf_spec_n_10) {
  ...
  int16_t res1 = scp_sscanf(str, format, s1, s2);
...
Suite *test_sscanf_n(void) {
  Suite *s = suite_create("\033[33m-=scp_sscanf_n=-\033[0m");
