...
START_TEST(sscanf_spec_real_1) {
  ...
  int16_t res1 = scp_sscanf(str, format, &d1, &q1, &z1);
...
START_TEST(sscanf_spec_real_3) {
  ...
  int16_t res1 = scp_sscanf(str, format, &nan11, &nan12, &inf11, &inf12, &inf13,
                            &inf14, &inf15);
...
START_TEST(sscanf_spec_real_8) {
  ...
  int16_t res1 = scp_sscanf(str, format, &d1, &q1, &z1, &w1);
...
START_TEST(sscanf_spec_real_10) {
  ...
  int16_t res1 = scp_sscanf(str, format, &d1, &q1);
...
START_TEST(sscanf_spec_real_20) {
  ...
  int16_t res1 = scp_sscanf(str, fstr, &a1, &b1, &c1, &d1);
...
START_TEST(sscanf_spec_real_24) {
  ...
  int16_t res1 = scp_sscanf(str, fstr, &a1, &b1, &c1);
...
START_TEST(sscanf_spec_real_30) {
  ...
  int16_t res1 = scp_sscanf(str, fstr, &n1, &n2);
...
Suite *test_sscanf_f(void) {
  Suite *s = suite_create("\033[33m-=scp_sscanf_f=-\033[0m");
