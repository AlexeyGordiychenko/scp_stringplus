...
int main(void) {
  ...
  Suite *s21_string_test[] = {
      ...
      test_strncmp(),        test_strncpy(),   test_strcspn(),
      ...
      test_sprintf_f(),      test_sprintf_e(), test_sprintf_c(),
      test_sprintf_string(), test_to_upper(),  test_to_lower(),
      test_insert(),         test_trim(),      test_sscanf_d(),
      test_sscanf_c(),       test_sscanf_s(),  test_sscanf_i(),
      test_sscanf_o(),       test_sscanf_u(),  test_sscanf_x(),
      test_sscanf_p(),       test_sscanf_n(),  NULL};
