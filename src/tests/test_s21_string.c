...
int main(void) {
  ...
  Suite *s21_string_test[] = {test_memchr(),          test_memcmp(),
                              ...
                              test_sprintf_c(),       test_sprintf_s(),
                              test_sprintf_i(),       test_sprintf_e(),
                              test_sprintf_f(),       test_sprintf_g(),
                              test_sprintf_o(),       test_sprintf_u(),
                              test_sprintf_x1(),      test_sprintf_x2(),
                              test_sprintf_p(),       test_sprintf_n(),
                              test_sprintf_percent(),

                              test_to_upper(),        test_to_lower(),
                              test_insert(),          test_trim(),

                              test_sscanf_d(),        test_sscanf_c(),
                              test_sscanf_s(),        test_sscanf_i(),
                              test_sscanf_o(),        test_sscanf_u(),
                              test_sscanf_x(),        test_sscanf_p(),
                              test_sscanf_n(),        test_sscanf_percent(),
                              test_sscanf_f(),        NULL};
