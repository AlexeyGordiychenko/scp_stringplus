...
int main(void) {
  ...
  Suite *s21_string_test[] = {test_memchr(),          test_memcmp(),
                              ...
                              test_strtok(),          test_sprintf_signed(),
                              test_sprintf_o(),       test_sprintf_hex(),
                              test_sprintf_HEX(),     test_sprintf_n(),
                              test_sprintf_percent(), test_sprintf_u(),
                              test_sprintf_p(),       test_sprintf_i(),
                              test_sprintf_f(),       test_sprintf_e(),
                              test_sprintf_c(),       test_sprintf_string(),
